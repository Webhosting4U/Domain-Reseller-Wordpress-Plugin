...
class WH4U_Admin_History {
    ...
    public static function render_page() {
        ...
        <div class="wrap wh4u-admin-wrap">
            ...
            <ul class="subsubsub">
                <li><a href="<?php echo esc_url( admin_url( 'admin.php?page=wh4u-domains-history' ) ); ?>"<?php echo esc_attr( empty( $status ) ? ' class="current"' : '' ); ?>><?php esc_html_e( 'All', 'wh4u-domains' ); ?> <span class="count">(<?php echo esc_html( $total ); ?>)</span></a> |</li>
                <?php foreach ( $valid_statuses as $i => $s ) : ?>
                    <li><a href="<?php echo esc_url( admin_url( 'admin.php?page=wh4u-domains-history&order_status=' . rawurlencode( $s ) ) ); ?>"<?php echo esc_attr( $status === $s ? ' class="current"' : '' ); ?>><?php echo esc_html( $status_labels[ $s ] ); ?></a><?php echo ( $i < count( $valid_statuses ) - 1 ) ? ' |' : ''; ?></li>
                <?php endforeach; ?>
            </ul>
    ...
    public static function render_public_orders_page() {
        ...
        <div class="wrap wh4u-admin-wrap">
            ...
            <ul class="subsubsub">
                <li><a href="<?php echo esc_url( admin_url( 'admin.php?page=wh4u-domains-public-orders' ) ); ?>"<?php echo esc_attr( empty( $status ) ? ' class="current"' : '' ); ?>><?php esc_html_e( 'All', 'wh4u-domains' ); ?> <span class="count">(<?php echo esc_html( $query->found_posts ); ?>)</span></a> |</li>
                <?php foreach ( $valid_statuses as $i => $s ) : ?>
                    <li><a href="<?php echo esc_url( admin_url( 'admin.php?page=wh4u-domains-public-orders&order_status=' . rawurlencode( $s ) ) ); ?>"<?php echo esc_attr( $status === $s ? ' class="current"' : '' ); ?>><?php echo esc_html( $status_labels[ $s ] ); ?></a><?php echo ( $i < count( $valid_statuses ) - 1 ) ? ' |' : ''; ?></li>
                <?php endforeach; ?>
            </ul>
